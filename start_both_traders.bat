...
REM Fenster 1: USDCAD (Two-Stage v4: H1+M5, Alle Regime, Schwelle 52%)
start "MT5-Trader-USDCAD" cmd /k "cd /d "C:\Users\Sebastian Setnescu\mt5_trading" && venv\Scripts\activate.bat && python live\live_trader.py --symbol USDCAD --version v4 --schwelle 0.52 --regime_filter 0,1,2 --atr_sl 1 --atr_faktor 1.5 --lot 0.01 --two_stage_enable 1 --two_stage_ltf_timeframe M5 --two_stage_version v4 --mt5_server SwissquoteLtd-Server --mt5_login 6202835 --mt5_password *0YsQqAk"
...
echo.
echo Fenster 1: USDCAD (Two-Stage v4: H1+M5, Schwelle 52%%, Alle Regime)
